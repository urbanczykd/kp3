class Admin::SponsorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @sponsor.save
        format.html { redirect_to(admin_sponsors_path, :notice => 'Sponsor został dodany.') }
  ...
  def update
    ...
    respond_to do |format|
      if @sponsor.update_attributes(params[:sponsor])
        format.html { redirect_to(admin_sponsors_path, :notice => 'Sponsor został pomyślnie zaktualizowany.') }
        format.xml  { head :ok }
      else
