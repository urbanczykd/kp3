...
AppConfig.advanced_mce_options = {
    ...
    :theme_advanced_buttons1 => %w{save formatselect fontsizeselect bold italic underline forecolor backcolor separator justifyleft justifycenter justifyright indent outdent separator bullist numlist},
    :theme_advanced_buttons2 => %w{separator link unlink image media separator undo redo help code separator pasteword},
    :theme_advanced_buttons3 => [],
    :plugins => %w{media preview curblyadvimage inlinepopups safari paste save},
