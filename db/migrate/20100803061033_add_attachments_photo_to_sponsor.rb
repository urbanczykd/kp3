class AddAttachmentsPhotoToSponsor < ActiveRecord::Migration
  ...
  def self.down
    remove_column :sponsors, :photo_file_name
    remove_column :sponsors, :photo_content_type
    remove_column :sponsors, :photo_file_size
    remove_column :sponsors, :photo_updated_at
  end
end
