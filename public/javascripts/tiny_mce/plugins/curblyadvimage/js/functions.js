...
function upload_callback(resource){
$.ajax({type: "GET", url: "/attachments/manage?media=print&magazine_id="+resource+"&page=1", dataType: "script"});
}	
...
function ts_upload_image_path() {
  ...
  $('#media_magazine_id').val(path[3]);
  return "/attachments/create?media=print&magazine_id="+path[3];
}
